  ...
  return (
    <footer className="bg-base-300 text-base-content px-10 py-12">
      <div className="max-w-6xl mx-auto grid gap-10 grid-cols-1 sm:grid-cols-2 md:grid-cols-3">
        {/* Contact Info */}
        <div>
          <h6 className="footer-title text-lg font-bold mb-2">Contact Info</h6>
          <p className="link link-hover">Email: golapraj47@gmail.com</p>
          <p className="link link-hover">Phone: 01707115247</p>
      ...
      <div className="text-center mt-10 text-sm text-gray-500">
        © 2025 Golap's Garden App. All rights reserved.
      </div>
    </footer>
  );
};
